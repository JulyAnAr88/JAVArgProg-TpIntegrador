...
public class ReportesController {
	 ...
	 * */
	public TecnicxController informarTecnicxMasRapidx() {
		return null;}
	 ...
	 * @param dias
	 * */
	public TecnicxController informarTecnicxMasIncidentes(int dias) {
		return null;}
	 ...
	 * @param dias
	 * */
	public TecnicxController informarTecnicxMasIncidentesPorEspecialidad(int dias) {
		return null;}
	 ...
	 * @param tecnicx
	 * */
	public List<Integer> informarIncidentesDiarios(TecnicxController tecnicx) {
